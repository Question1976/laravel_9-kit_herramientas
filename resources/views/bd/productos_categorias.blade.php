        ...
        <div class="row">
            <div class="col-12 mt-3">
                <div class="text-center">
                    <p class="display-6">Productos por categoría</p>
                    <p class="text-center">Categoría actual: <span class="fw-bold text-primary">{{ $categoria->nombre }}</span> || Número de registros por categoría: <span class="fw-bold text-primary">{{ $datos->count() }}</span></p>
                </div>                              
